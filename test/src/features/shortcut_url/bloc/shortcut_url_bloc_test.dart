...
void main() {
  ...
  test(
    'should handle duplicate URL input',
    () async {
  ...
  test(
    'should handle successful URL generation',
    () async {
  ...
  test(
    'should handle failure DataNetworkException in URL generation',
    () async {
      when(() => mockShortcutUrlRepository.postShortcutUrl(any())).thenAnswer(
  ...
  test(
    'should handle failure DataClientException in URL generation',
    () async {
      when(() => mockShortcutUrlRepository.postShortcutUrl(any())).thenAnswer(
        (final _) async => FailureState<ShortcutUrlModel?>(
  ...
  test(
    'should handle failure DataParseException in URL generation',
    () async {
      when(() => mockShortcutUrlRepository.postShortcutUrl(any())).thenAnswer(
        (final _) async => FailureState<ShortcutUrlModel?>(
